...
def reservation_now():
    ...
    if ava_g == 0:
        ...
        _action = input("Ingresa el número del campo que quieres reservar: ")
        
        try:
            selected_gate = int(_action)
        except ValueError:
            print("Ingrese un número válido.")
            return [0, 0]
        
        if selected_gate in ava_g:
            print("Reserva exitosa para el campo:", selected_gate)
            return [selected_gate, 1]
        else:
            print("Campo no válido. Reserva fallida.")
            return [0, 0]
